...
import org.example.generator.model.AuctionGenerator;
import org.example.generator.model.BidGenerator;
import org.example.generator.model.PersonGenerator;
...
public class NexmarkGenerator implements Iterator<NexmarkGenerator.NextEvent>, Serializable {
    ...
    public static class NextEvent implements Comparable<NextEvent> {
        ...
        public NextEvent(long wallclockTimestamp, long eventTimestamp, Event event) {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(wallclockTimestamp, event);
        }
    ...
    public NexmarkGenerator withEventFilter(GeneratorConfig.EventFilter eventFilter) {
        config.eventFilter = eventFilter;
        return this;
    }

    public NexmarkGenerator withMaxEvents(long maxEvents) {
    ...
    public NextEvent nextEvent() {
        ...
        Event event;
        switch (config.eventFilter) {
            case PERSON: {
                event = new Event(PersonGenerator.nextPerson(newEventId, random, adjustedEventTimestamp, config));
            }
            case AUCTION: {
                event = new Event(AuctionGenerator.nextAuction(eventsCountSoFar, newEventId, random, adjustedEventTimestamp, config));
            }
            case BID: {
        ...
        eventsCountSoFar++;
        return new NextEvent(wallclockTimestamp, adjustedEventTimestamp, event);
    }
