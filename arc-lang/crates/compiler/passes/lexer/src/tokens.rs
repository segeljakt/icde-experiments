...
pub const KEYWORDS: &[&str] = &[
    "mod", "and", "as", "break", "continue", "def", "desc", "do", "else", "for", "from", "fun",
    "group", "if", "in", "into", "join", "loop", "match", "not", "on", "or", "of", "return",
    "select", "compute", "repeat", "throw", "try", "type", "val", "var", "where", "with", "while",
    "use", "union", "over", "roll", "order", "enum", "rust",
];
